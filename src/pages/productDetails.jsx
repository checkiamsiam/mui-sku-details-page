      ...
      <Stack direction={{ xl: "column", sm: "row" }} spacing={2}>
          ...
          <Card sx={{ padding: "1.5rem" }}>
            <Stack direction="row" spacing={3}>
              ...
              <div style={{ width: "40%" }}>
                ...
                <Stack direction="row" justifyContent="space-between" spacing={1} fontSize="12px" marginTop="10px">
                  <Stack width="75%">
                    ...
                    <LinearProgress
                      variant="determinate"
                      value={25}
                      sx={{ padding: "1px", borderRadius: "5px", bgcolor: "red", margin: "2px 0px" }}
                    />
                    <Stack direction="row" justifyContent="space-between">
                      <span>SAR 17,87</span>
                      <span>SAR 20,87</span>
        ...
        <Stack sx={{ width: "40%" }}>
          <Card sx={{ padding: "1.5rem" }}>
            <Stack direction="column" spacing={1} fontSize="12px">
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <span style={{ width: "40%", fontWeight: "bold", color: "#7A797D" }}>
                  Sku Title: <InfoIcon htmlColor="#999999" fontSize="3px" />
                </span>
                <span style={{ width: "60%", color: "#7A797D" }}>Portable Diaper Organizer</span>
              </Stack>
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <span style={{ width: "40%", fontWeight: "bold", color: "#7A797D" }}>
                  Sku Category: <InfoIcon htmlColor="#999999" fontSize="3px" />
                </span>
                <span style={{ width: "60%", color: "#7A797D" }}>
                  <Link href="#" underline="none">
                    Baby Products
                  </Link>
                </span>
              ...
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                ...
                <span style={{ width: "60%", color: "#7A797D" }}>Diapering</span>
              </Stack>
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <span style={{ width: "40%", fontWeight: "bold", color: "#7A797D" }}>
                  Sku Sub-Type: <InfoIcon htmlColor="#999999" fontSize="3px" />
                </span>
                <span style={{ width: "60%", color: "#7A797D" }}>Diaper Stackers & Organisers</span>
              </Stack>
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <span style={{ width: "40%", fontWeight: "bold", color: "#7A797D" }}>
